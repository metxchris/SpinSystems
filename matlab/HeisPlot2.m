...
for varNumber =11:14
    ...
    switch varNumber
        ...
        case {21,22,23,24,25,26,27,28,29} % q = 2
            ...
            switch varNumber
                ...
                case 24
                    fileName = '2d Heis, C_a';delLegend=0;legLocation='southeast';
                    ...
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 25
                    fileName = '2d Heis, V_a';delLegend=0;
      ...
      case {31,32,33,34,35,36,37} % q = 2
            ...
            switch varNumber
                case 31
                    fileName = '2d Heis, M_b';
                    plotTitle = '\bf Mean Magnetization';
                    labelY1 = '$|\left<M\right>|$ ';moveY=12;
                    varY{vN}=var(:,2);MINY=0;
                case 32
                    fileName = '2d Heis, E_b';yprec='%1.1f';
                    plotTitle = '\bf Mean Energy';
                    labelY1 = '$\left<H\right>$ ';moveY=20;
                    varY{vN}=var(:,4);
                case 33
                    fileName = '2d Heis, X_b';delLegend=0;%legLocation='northeast';
                    plotTitle = '\bf Magnetic Susceptibility';
                    labelY1 = '$\chi_{_M}$ '; moveY=20;
                    varY{vN}=var(:,10);yprec='%1.0f';
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,2))./diff(var(:,1)));
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 34
                    fileName = '2d Heis, C_b';delLegend=0;%legLocation='southeast';
                    plotTitle = '\bf Specific Heat';
                    labelY1 = '$C_{\fontsize{8}{8}\selectfont H}$ ';
                    varY{vN}=var(:,11);yprec='%1.1f';
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,4))./diff(var(:,1)));
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 35
                    fileName = '2d Heis, V_b';delLegend=0;
                    plotTitle = '\bf Energy Variance';
                    labelY1 = '$\left<(\Delta H)^2\right>$ ';
                    varY{vN}=var(:,11).*(var(:,1).^2);yprec='%1.1f';
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,4))./diff(var(:,1))).*((var(1:end-1,1)+diff(var(:,1))./2).^2);
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 36
                    fileName = '2d Heis, M4_b';
                    plotTitle = '\bf $4^{\rm th}$ Order Magnetic Cumulant';
                    labelY1 = '$Q_M^{(4)}$ ';moveY=30;
                    varY{vN}=var(:,8);yprec='%1.2f';
                case 37
                    fileName = '2d Heis, E4_b';
                    plotTitle = '\bf $4^{\rm th}$ Order Energy Cumulant';
                    labelY1 = '$Q_E^{(4)}$ ';moveY=12;MINY=0;
                    varY{vN}=var(:,9);yprec='%1.1f';yAdjustment=10^(-4);yA='$10^{-4}$';
            end
    ...
    case {51,52,53,54,55,56,57} % q = 2
            var=heis004;q=5;
            labelX1 = '$T$ '; labelX2 = '$(T_c = 1.703)$'; labelY2 = '';
            subTitle = '$q = 5$, $32^2$ grid, $10^6$ sweeps, $d = \delta_{ij}$';
            vN=1;varX{vN}=var(:,1);delLegend=1;xprec='%1.1f';yprec='%1.1f';
            leg{vN}='Simulated';lT{vN}='o';lW{vN}=1;mS{vN}=3;lC{vN}=lineColor{4};MAXX=2.4;
            
              switch varNumber
                case 51
                    fileName = '2d Heis, M_d';
                    plotTitle = '\bf Mean Magnetization';
                    labelY1 = '$|\left<M\right>|$ ';moveY=12;
                    varY{vN}=var(:,2);MINY=0;
                case 52
                    fileName = '2d Heis, E_d';yprec='%1.1f';
                    plotTitle = '\bf Mean Energy';
                    labelY1 = '$\left<H\right>$ ';moveY=24;
                    varY{vN}=var(:,4);
                case 53
                    fileName = '2d Heis, X_d';delLegend=0;%legLocation='northeast';
                    plotTitle = '\bf Magnetic Susceptibility';
                    labelY1 = '$\chi_{_M}$ '; moveY=20;
                    varY{vN}=var(:,10);yprec='%1.0f';
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,2))./diff(var(:,1)));
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 54
                    fileName = '2d Heis, C_d';delLegend=0;%legLocation='southeast';
                    plotTitle = '\bf Specific Heat';
                    labelY1 = '$c_N$ ';
                    varY{vN}=var(:,11);yprec='%1.0f';
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,4))./diff(var(:,1)));
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 55
                    fileName = '2d Heis, V_d';delLegend=0;
                    plotTitle = '\bf Energy Variance';
                    labelY1 = '$\left<(\Delta H)^2\right>$ ';
                    varY{vN}=var(:,11).*(var(:,1).^2);yprec='%1.0f';moveY=20;
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,4))./diff(var(:,1))).*((var(1:end-1,1)+diff(var(:,1))./2).^2);
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 56
                    fileName = '2d Heis, M4_d';
                    plotTitle = '\bf $4^{\rm th}$ Order Magnetic Cumulant';
                    labelY1 = '($V_m)^4$ ';moveY=25;
                    varY{vN}=var(:,8);yprec='%1.1f';yAdjustment=10^(-2);yA='$10^{-\;2}$';
                case 57
                    fileName = '2d Heis, E4_d';
                    plotTitle = '\bf $4^{\rm th}$ Order Energy Cumulant';
                    labelY1 = '$(V_E)^4$ ';moveY=24;yAdjustment=10^(-3);yA='$10^{-\;3}$';
                    varY{vN}=var(:,9);yprec='%1.1f';
            end
    case {61,62,63,64,65,66,67} % q = 4
            var=heis005;q=4;
            labelX1 = '$T$ '; labelX2 = '$(T_c = 1.821)$'; labelY2 = '';
            subTitle = '$q = 4$, $32^2$ grid, $10^6$ sweeps, $d = \delta_{ij}$';
            vN=1;varX{vN}=var(:,1);delLegend=1;xprec='%1.1f';yprec='%1.1f';
            leg{vN}='Simulated';lT{vN}='o';lW{vN}=1;mS{vN}=3;lC{vN}=lineColor{5};MAXX=2.4;
            
              switch varNumber
                case 61
                    fileName = '2d Heis, M_e';
                    plotTitle = '\bf Mean Magnetization';
                    labelY1 = '$|\left<M\right>|$ ';moveY=12;
                    varY{vN}=var(:,2);MINY=0;
                case 62
                    fileName = '2d Heis, E_e';yprec='%1.1f';
                    plotTitle = '\bf Mean Energy';
                    labelY1 = '$\left<H\right>$ ';moveY=24;
                    varY{vN}=var(:,4);
                case 63
                    fileName = '2d Heis, X_e';delLegend=0;%legLocation='northeast';
                    plotTitle = '\bf Magnetic Susceptibility';
                    labelY1 = '$\chi_{_M}$ '; moveY=20;
                    varY{vN}=var(:,10);yprec='%1.0f';
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,2))./diff(var(:,1)));
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 64
                    fileName = '2d Heis, C_e';delLegend=0;%legLocation='southeast';
                    plotTitle = '\bf Specific Heat';
                    labelY1 = '$c_N$ ';
                    varY{vN}=var(:,11);yprec='%1.0f';
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,4))./diff(var(:,1)));
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 65
                    fileName = '2d Heis, V_e';delLegend=0;
                    plotTitle = '\bf Energy Variance';
                    labelY1 = '$\left<(\Delta H)^2\right>$ ';
                    varY{vN}=var(:,11).*(var(:,1).^2);yprec='%1.0f';moveY=20;
                    vN=2;varX{vN}=var(1:end-1,1)+diff(var(:,1))./2;varY{vN}=abs(diff(var(:,4))./diff(var(:,1))).*((var(1:end-1,1)+diff(var(:,1))./2).^2);
                    leg{vN}='Numerical';lT{vN}='-.';lW{vN}=1.0;mS{vN}=3;lC{vN}=lC{1}/3;
                case 66
                    fileName = '2d Heis, M4_e';
                    plotTitle = '\bf $4^{\rm th}$ Order Magnetic Cumulant';
                    labelY1 = '($V_m)^4$ ';moveY=25;
                    varY{vN}=var(:,8);yprec='%1.1f';yAdjustment=10^(-2);yA='$10^{-\;2}$';
                case 67
                    fileName = '2d Heis, E4_e';
                    plotTitle = '\bf $4^{\rm th}$ Order Energy Cumulant';
                    labelY1 = '$(V_E)^4$ ';moveY=24;yAdjustment=10^(-3);yA='$10^{-\;3}$';
                    varY{vN}=var(:,9);yprec='%1.1f';
            end 
